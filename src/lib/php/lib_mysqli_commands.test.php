...
// init database
// $mysqli_interface_instance = new lib_mysqli_interface(); # create instance from class
// config::set('mysqli_interface',$mysqli_interface_instance);
...
$_COOKIE["hyperhelp"] = $user->session = salt(); // set session on client side, this is a random id that identifies the access rights of the client
...
$users_array = $lib_mysqli_commands_instance->GetUserBySession($_COOKIE["hyperhelp"]);
$user = getFirstElementOfArray($users_array);
success();
